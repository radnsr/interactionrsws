...
public class LoginController {
	...
	return productInfo;
        ...
        @RequestMapping(value = {"/v1/ingredients/ingredientNames/{ingredientNames}/{userID}"}, produces = {MediaType.APPLICATION_JSON_VALUE}, method = RequestMethod.GET)
        public ProductInfo findByIngName(@PathVariable(value="ingredientNames") List<String> ingredientNames, @PathVariable(value="userID") String userID){
            ProductInfo productInfo;
		try{
